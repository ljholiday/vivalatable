...
// Get public communities with a simple database query since method doesn't exist
					...
					<?php foreach ($user_communities as $community) : ?>
						<div class="vt-section vt-border vt-p-4">
							<?php if (!empty($community->featured_image)) : ?>
								<div class="vt-mb-4">
									<img src="<?php echo htmlspecialchars($community->featured_image); ?>" alt="<?php echo htmlspecialchars($community->name); ?>" style="width: 100%; height: 150px; object-fit: cover; border-radius: 4px;">
								</div>
							<?php endif; ?>
								...
								<div class="vt-flex-1">
									...
									<div class="vt-flex vt-gap vt-flex-wrap vt-mb-2">
										<span class="vt-badge vt-badge-<?php echo $community->role === 'admin' ? 'primary' : 'success'; ?>">
											<?php echo htmlspecialchars(ucfirst($community->role)); ?>
										</span>
							...
							<div class="vt-flex vt-flex-between vt-flex-wrap vt-gap">
								...
								<div class="vt-flex vt-gap">
									...
									<?php if ($community->role === 'admin') : ?>
										<a href="/manage-community/<?php echo intval($community->id); ?>/settings" class="vt-btn">
											Manage
										</a>
									<?php endif; ?>
								</div>
					...
					<div class="vt-text-center vt-p-4">
						...
						<div class="vt-flex vt-gap vt-justify-center">
							...
							<?php if (VT_Feature_Flags::can_user_create_community()) : ?>
								<a href="/create-community" class="vt-btn">
									Create Community
								</a>
							<?php endif; ?>
						</div>
				...
				<div class="vt-section vt-border vt-p-4">
					...
					<div class="vt-section-header vt-flex vt-flex-between vt-mb-4">
						...
						<div class="vt-badge vt-badge-<?php echo $community->visibility === 'public' ? 'success' : 'secondary'; ?>">
							<?php echo htmlspecialchars(ucfirst($community->visibility)); ?>
						</div>
					</div>
						<div class="vt-mb-4">
							<div class="vt-flex vt-gap">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	joinBtns.forEach(btn => {
		btn.addEventListener('click', function(e) {
			...
			if (!window.vivalatable_user || !window.vivalatable_user.id) {
